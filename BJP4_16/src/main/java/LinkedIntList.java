...
public class LinkedIntList {
    ...
    public void firstLast() {
        /*
        moves the first element of the
        list to the back end of the list.
         */

        // two vars point to front:
        // one for traversing the list and the other
        ...
        // append node with value at front of
        // original list
        current.next = first;

        // Break out of cyclical list
        current.next.next = null;

    }

    public void set(int index, int value) {
        // if index is 0, set front of list
        // to specified value
        if (index == 0) {
            front.data = value;
        } else { // traverse list, looking
            ...
            // set next node to the specified
            // value
    ...
    public int min() {
        if (front == null) { // list is empty
            ...
            // traverse list, noting ints less than
            // the current count
            while (current != null) {
    ...
    public boolean isSorted() {
        /*
        returns true if the list is in sorted
        (nondecreasing) order and returns
        false otherwise.
         */
        if (front == null) {
            return true;
    ...
    public int lastIndexOf(int value) {
        ...
        and that returns the index in the list
        of the last occurrence of that value, or
        ...
        // traverse list, updating "last"
        // each time the value appears with the
        // current index
        while (current != null) {
    ...
    public int countDuplicates() {
        /*
        Returns the number of duplicates in a
        sorted list. The list will be in sorted
        order, so all of the duplicates will be
        grouped together.
         */
        if (front == null) {
            return 0;
